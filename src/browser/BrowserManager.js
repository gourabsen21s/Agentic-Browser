...
const DOMService_1 = require("./DOMService"); // Import the DOMService you just created
const logger = (0, logger_1.getLogger)('BrowserManager'); // Get a logger instance for this service
/**
...
class BrowserManager {
    constructor() {
        this.browser = null; // The Playwright Browser instance
        this.context = null; // The Playwright BrowserContext instance
        this.page = null; // The current Playwright Page instance
     ...
     */
    ensureBrowserComponents(component) {
     ...
     */
    launch() {
        return __awaiter(this, arguments, void 0, function* (headless = false, browserProfile) {
            try {
                this.browser = yield playwright_1.chromium.launch({ headless }); // Launch Chromium browser
                if (browserProfile) {
                    // Merge provided profile settings with the default profile
                    this.browserProfile = Object.assign(Object.assign({}, this.browserProfile), browserProfile);
                }
                ...
                this.page = yield this.context.newPage(); // Open a new page in the context
                this.domService = new DOMService_1.DOMService(this.page); // Initialize DOMService with the active page
    ...
    goBack() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            try {
                const response = yield this.page.goBack(); // Perform the 'go back' action
                if (response === null) {
    ...
    goForward() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            try {
                const response = yield this.page.goForward(); // Perform the 'go forward' action
                if (response === null) {
    ...
    click(selector) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.page.click(selector); // Click the element
    ...
    type(selector, text) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.page.fill(selector, text); // Fill the input field with text
    ...
    extractText(selector) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const text = yield this.page.textContent(selector); // Get the text content
     ...
     */
    screenshot(screenshotPath_1) {
        return __awaiter(this, arguments, void 0, function* (screenshotPath, fullPage = false) {
            this.ensureBrowserComponents('page');
            if (screenshotPath && typeof screenshotPath !== 'string') {
                throw new Error('Invalid path provided for screenshot(). Path must be a string.');
            }
            try {
                const buffer = yield this.page.screenshot({ path: screenshotPath, fullPage }); // Take screenshot
     ...
     */
    highlightDomTreeElements(scriptPath_1) {
     ...
     */
    getElementDetailsByIndex(scriptPath_1, index_1) {
    ...
    evaluate(fn, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.page.evaluate(fn, ...args);
    ...
    uploadFile(selector, filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const input = yield this.page.$(selector); // Find the input element
                if (!input) {
                    throw new Error(`File input element not found for selector: ${selector}`);
                }
                yield input.setInputFiles(filePath); // Set the file(s) to the input
    ...
    dragAndDrop(sourceSelector, targetSelector) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.page.dragAndDrop(sourceSelector, targetSelector); // Perform drag and drop
    ...
    newTab(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const newPage = yield this.context.newPage(); // Open new page
                this.page = newPage; // Set as current page
                this.domService = new DOMService_1.DOMService(this.page); // Re-initialize DOMService for the new page
                if (url) {
    ...
    switchToTab(index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.domService = new DOMService_1.DOMService(this.page); // Update DOMService to the switched page
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (pageToClose && !pageToClose.isClosed()) {
                    yield pageToClose.close(); // Close the selected page
                    logger.info(`Tab ${index !== undefined ? `at index ${index}` : 'current'} closed.`);
                }
                else if (pageToClose === null || pageToClose === void 0 ? void 0 : pageToClose.isClosed()) {
                ...
                if (remainingPages.length > 0) {
                    ...
                    this.domService = new DOMService_1.DOMService(this.page); // Update DOMService to the new active page
     ...
     */
    handleDialog() {
        return __awaiter(this, arguments, void 0, function* (accept = true, promptText) {
            this.ensureBrowserComponents('page');
            ...
            try {
                ...
                this.page.once('dialog', (dialog) => __awaiter(this, void 0, void 0, function* () {
                    logger.info(`Dialog of type "${dialog.type}" with message: "${dialog.message}" detected.`);
                    if (accept) {
                        yield dialog.accept(promptText); // Accept the dialog, optionally with prompt text
                        logger.info(`Dialog accepted${promptText ? ` with text: "${promptText}"` : ''}.`);
                    }
                    else {
                        yield dialog.dismiss(); // Dismiss the dialog
    ...
    scrollTo(selector) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.page.waitForSelector(selector, { state: 'visible', timeout: 5000 });
                // Use Playwright's $eval to execute `scrollIntoView` on the element in the browser context
                yield this.page.$eval(selector, el => el.scrollIntoView({ behavior: 'smooth', block: 'center' }));
    ...
    selectOption(selector, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const selectedValues = yield this.page.selectOption(selector, value); // Select the option(s)
    ...
    extractAttribute(selector, attribute) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const value = yield this.page.getAttribute(selector, attribute); // Get attribute value
                if (value === null) {
    ...
    getCookies() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('context');
            try {
                const cookies = yield this.context.cookies(); // Get all cookies
    ...
    setCookie(cookie) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.context.addCookies([cookie]); // Add the cookie
    ...
    clearCookies() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('context');
            try {
                yield this.context.clearCookies(); // Clear all cookies
    ...
    getLocalStorage(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const value = yield this.page.evaluate((k) => localStorage.getItem(k), key); // Get item from localStorage
    ...
    setLocalStorage(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.page.evaluate(([k, v]) => localStorage.setItem(k, v), [key, value]); // Set item in localStorage
    ...
    clearLocalStorage() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            try {
                yield this.page.evaluate(() => localStorage.clear()); // Clear localStorage
    ...
    clearSessionStorage() {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            try {
                yield this.page.evaluate(() => sessionStorage.clear()); // Clear sessionStorage
     ...
     */
    downloadFile(selector, downloadPath) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            if (!selector || typeof selector !== 'string') {
            ...
            try {
                ...
                yield download.saveAs(finalDownloadPath); // Save the downloaded file
     ...
     * @throws An error if the browser page is not launched or parameters are invalid.
     */
    interceptRequests(urlPattern, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            if (!urlPattern) {
            ...
            try {
                yield this.page.route(urlPattern, handler); // Set up request interception
    ...
    emulateDevice(deviceName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.context) {
                    yield this.context.close(); // Close existing context
                    logger.info('Existing browser context closed for device emulation.');
                }
                this.context = yield this.browser.newContext(Object.assign({}, device)); // Create new context with device settings
                this.page = yield this.context.newPage(); // Open new page in the emulated context
                this.domService = new DOMService_1.DOMService(this.page); // Re-initialize DOMService
    ...
    setUserAgent(userAgent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.context = yield this.browser.newContext({ userAgent }); // Create new context with custom user agent
                this.page = yield this.context.newPage(); // Open new page
                this.domService = new DOMService_1.DOMService(this.page); // Re-initialize DOMService
     ...
     */
    waitForNavigation() {
        return __awaiter(this, arguments, void 0, function* (waitUntil = 'domcontentloaded') {
            this.ensureBrowserComponents('page');
            ...
            try {
                yield this.page.waitForNavigation({ waitUntil });
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.browser) {
                    yield this.browser.close(); // Close the browser
     ...
     */
    getStateSummary(cacheClickableElementsHashes) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ensureBrowserComponents('page');
            this.ensureBrowserComponents('domService');
            ...
            const screenshot = yield this.page.screenshot().then(buf => buf.toString('base64')).catch(e => {
            ...
            const tabs = yield Promise.all(pagesInContext.map((p, idx) => __awaiter(this, void 0, void 0, function* () {
                return ({
                    id: idx,
                    title: yield p.title(),
                    url: p.url(),
            ...
            const clickableElements = yield this.domService.getClickableElements();
            const selectorMap = {};
