...
const logger = (0, logger_1.getLogger)('HistoryTreeProcessorService'); // Get a logger instance for this service
/**
...
class HistoryTreeProcessor {
     ...
     */
    static findHistoryElementInTree(historicalElement, currentSelectorMap) {
