...
exports.ProductTelemetry = void 0;
const logger_1 = require("./logger"); // Import your custom logger
const logger = (0, logger_1.getLogger)('TelemetryService'); // Get a logger instance for this service
/**
...
class ProductTelemetry {
    constructor() {
        this.eventsQueue = []; // Internal queue to hold telemetry events
        this.isFlushing = false; // A flag to prevent multiple concurrent flush operations
    }
    /**
            ...
            while (this.eventsQueue.length > 0) {
                ...
                if (event) {
                    try {
                        ...
                        yield new Promise(resolve => setTimeout(resolve, 50)); // Simulate a small network delay
...
exports.ProductTelemetry = ProductTelemetry;
